        ...
        <ContentContainer>
          ...
          <CriacaoDeSitesContainer>
            ...
            <StepsCard>
              ...
              <p>
                Depois que o conteúdo estiver pronto, a nossa equipe irá começar
                a trabalhar na estrutura e nas funcionalidades do site. Como
                também, a programação de elementos interativos, como formulários
                de contato ou botões de compra.
              </p>
            </StepsCard>
            <StepsCard>
              <CardImage>
              ...
              <p>
                Antes de lançar o site, a nossa equipe irá realizar testes para
                garantir que tudo esteja funcionando corretamente para garantir
                a compatibilidade e acessibilidade. Quando tudo estiver pronto,
                o site será lançado e tornado acessível ao público.
              </p>
            </StepsCard>
          </CriacaoDeSitesContainer>
          <p>
            ...
            funcionando corretamente. Isso pode incluir a realização de backups
            regulares, correção de erros e atualização de conteúdo.
          </p>
        </ContentContainer>
        <BudgetButton />
      </ServiceContainer>
