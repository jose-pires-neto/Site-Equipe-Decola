...
export default function LandingPage() {
  return (
    <>
      <Head>
        <title>Landing Page | Equipe Decola</title>
      </Head>
      <ServiceSection>
        <ServiceContainer>
          <h1>Landing Page</h1>
          ...
          <TextAndImageContainer>
            ...
            <div>
              <p>
                ...
                da estratégia de marketing digital de muitas empresas. As
                landing pages são páginas de destino específicas criadas para
                promover um produto ou serviço e convertem visitantes em
                clientes potenciais.
              </p>
            </div>
          </TextAndImageContainer>
          <p>
            ...
            tecnologias do mercado, para ajudar os nossos clientes a terem
            páginas de destino eficazes que atraem e convertem visitantes.
          </p>
          <hr />
          <ContentContainer>
            <LandingPageContainer>
              ...
              <div>
                <p>
                  Além disso, oferecemos serviços de gerenciamento de campanhas
                  de marketing, que incluem a criação de anúncios online e a
