...
export default function ProducaoDeConteudo() {
  return (
    <>
      <Head>
        <title>Produção de conteúdo | Equipe Decola</title>
      </Head>
      <ServiceSection>
        <ServiceContainer>
          ...
          <TextAndImageContainer>
            ...
            <div>
              <p>
                ...
                permite que as empresas comuniquem sua mensagem a um
                público-alvo específico de maneira criativa e eficaz. O conteúdo
                pode ser produzido em vários formatos, incluindo textos,
                imagens, vídeos, áudio e muito mais.
              </p>
            </div>
          </TextAndImageContainer>
          <ContentContainer>
            <p>
              Existem várias razões pelas quais a sua empresa precise de
              produção de conteúdo. Algumas das principais razões incluem:
            </p>
            <IconsContainer>
              <div>
            ...
            <p>
              ...
              criar conteúdo de alta qualidade que seja relevante para seu
              público-alvo e que ajude a estabelecer sua marca como líder em seu
              campo.
            </p>
          </ContentContainer>
          <BudgetButton />
