...
export default function IdentidadeVisual() {
  return (
    <>
      <Head>
        <title>Identidade Visual | Equipe Decola</title>
      </Head>
      <ServiceSection>
        <ServiceContainer>
          ...
          <TextAndImageContainer>
            ...
            <div>
              <p>
                ...
                da empresa, incluindo site, material de marketing e redes
                sociais.
              </p>
            </div>
          </TextAndImageContainer>
          <ContentContainer>
            <p>
              ...
              processo rigoroso. Isso inclui reunir informações sobre os
              objetivos e valores da empresa, bem como o público-alvo que a
              empresa deseja atingir. Com base nessas informações, criamos
              várias opções de design para o cliente escolher.
            </p>
            <p>
              O cliente tem a oportunidade de revisar as opções e fornecer
              feedback para a nossa equipe. Uma vez que o design final é
              aprovado pelo cliente, nós fornecemos todos os arquivos e
              instruções necessárias para o cliente usar a nova identidade
              visual em sua comunicação.
            </p>
            <p>
